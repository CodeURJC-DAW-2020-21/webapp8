...
public class DatabaseDataLoader {
    ...
    private void initDatabase() throws IOException {
        ...
        //Entries
        Entry entry1 = entryRepository.save(new Entry(1, "Pues esta es la primera entrada", "Esperemos que se muestre", LocalDateTime.now(), user1));
        Entry entry2 = entryRepository.save(new Entry(2, "Esta es otra de las entradas de prueba", "Pues por lo que parece si que se muestra si jeje", LocalDateTime.now(), user2));
        Entry entry3 = entryRepository.save(new Entry(3, "Esta es la entrada escrita por el usuario de angel", "Asi es soy la entrada escrita por angel", LocalDateTime.now(), user3));
        entryRepository.save(new Entry(4, "Pues esta es la primera entrada", "Esperemos que se muestre", LocalDateTime.now(), user1));
        entryRepository.save(new Entry(5, "Esta es otra de las entradas de prueba", "Pues por lo que parece si que se muestra si jeje", LocalDateTime.now(), user2));
        entryRepository.save(new Entry(6, "Esta es la entrada escrita por el usuario de angel", "Asi es soy la entrada escrita por angel", LocalDateTime.now(), user3));
        entryRepository.save(new Entry(7, "Pues esta es la primera entrada", "Esperemos que se muestre", LocalDateTime.now(), user1));
        entryRepository.save(new Entry(8, "Esta es otra de las entradas de prueba", "Pues por lo que parece si que se muestra si jeje", LocalDateTime.now(), user2));
        entryRepository.save(new Entry(9, "Esta es la entrada escrita por el usuario de angel", "Asi es soy la entrada escrita por angel", LocalDateTime.now(), user3));
        entryRepository.save(new Entry(10, "Pues esta es la primera entrada", "Esperemos que se muestre", LocalDateTime.now(), user1));
        entryRepository.save(new Entry(11, "Esta es otra de las entradas de prueba", "Pues por lo que parece si que se muestra si jeje", LocalDateTime.now(), user2));
        entryRepository.save(new Entry(12, "Pues esta es la doce entrada", "Esperemos que se muestres", LocalDateTime.now(), user1));
        entryRepository.save(new Entry(13, "Esta es otra de las entradas de prueba", "Pues por lo que parece si que se muestra si jejeje", LocalDateTime.now(), user2));
        entryRepository.save(new Entry(14, "Esta es la entrada escrita por el usuario de angel", "Asi es soy la entrada escrita por el angel", LocalDateTime.now(), user3));
